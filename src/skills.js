...
export const { playerPassive, weaponSkillList } = (function () {
    ...
    //                   |Offensive Tree|
    var preciseAttack = new newPassive(
        0,
        5,
        1,
        'Precise Attack',
    ...
    var piercingAttack = new newPassive(
        0,
        5,
        5,
        'Piercing Attack',
    ...
    var assasination = new newPassive(
        0,
        1,
        10,
        'Assasination',
    ...
    var combatTraining = new newPassive(
        0,
        5,
        1,
        'Combat Training',
    ...
    var combatMaster = new newPassive(
        0,
        5,
        5,
        'Combat Master',
    ...
    var physicalExercise = new newPassive(
        0,
        5,
        10,
        'Physical Exercise',
    ...
    var fierceImpact = new newPassive(
        0,
        5,
        15,
        'Fierce Impact',
    ...
    var elementalMastery = new newPassive(
        0,
        5,
        1,
        'Elemental Mastery',
    ...
    var MagicTraining = new newPassive(
        0,
        5,
        5,
        'Magic Training',
    ...
    var quickMeditation = new newPassive(
        0,
        5,
        15,
        'Quick Meditation',
    ...
    var mentalMastery = new newPassive(
        0,
        5,
        20,
        'Mental Mastery',
    ...
    var spiritualAttunement = new newPassive(
        0,
        5,
        25,
    ...
    //                  |Defensive Tree|
    var armorProficiency = new newPassive(
        0,
        5,
        1,
        'Armor Proficiency',
    ...
    var thornAura = new newPassive(
        ...
        'ThornAura',
        1,
        ' thorn damage(based on enemy damage, before any reductions)',
        true
    );
    var stoneSkin = new newPassive(
        0,
        5,
        20,
        'Stone Skin',
    ...
    var damageReflect = new newPassive(
        0,
        5,
        10,
        'Damage Reflect',
        'DamageReflect',
        1,
        'to reflect 50% damage',
        true
    );
    var sixthSense = new newPassive(
        0,
        5,
        15,
        'Sixth Sense',
    ...
    var constitution = new newPassive(
        0,
        5,
        10,
        'Constitution',
    ...
    //                  |Utility Tree|
    var miningAmount = new newPassive(
        0,
        5,
        1,
        'Mining Amount',
        'MiningAmount',
        1,
        'max amount you can mine at once',
        false
    );
    var herbalismAmount = new newPassive(
        0,
        5,
        1,
        'Herbalism Amount',
        'HerbalismAmount',
        1,
        'max amount you can gather at once',
        false
    );
    ...
    var storage = new newPassive(
        ...
        'Storage',
        1000,
        'total storage for resources',
        false
    );
    var herbalismCritical = new newPassive(
        0,
        5,
        5,
        'Prosperous grasp',
        'ProsperousGrasp',
        1,
        'chance for critical gather, which gives much more herbs',
        true
    );
    var miningCritical = new newPassive(
        0,
        5,
        10,
        'Cutting Technique',
        'CuttingTechnique',
        1,
        'chance for critical mine, which gives much more ores',
        true
    );
    ...
    var weaponSkillDamage = function (levelReq, name, image, type, type2, id, manaCost) {
        //default spell object constructor
        this.levelReq = levelReq;
        this.name = name;
        this.image = image;
    ...
    //SWORD SKILL
    var savageStrike = new weaponSkillDamage(
        1,
        'Savage Strike',
        'SavageStrike',
        'damage',
    ...
    var swordFinesse = new weaponSkillDamage(
        5,
        'Sword Finesse',
        'SwordFinesse',
        'passive',
    ...
    var parryAndRiposte = new weaponSkillDamage(
        10,
        'Parry and Riposte',
        'ParryAndRiposte',
        'counter',
    ...
    var sinisterSwing = new weaponSkillDamage(
        15,
        'Sinister Swing',
        'SinisterSwing',
        'damage',
    ...
    var rendingArc = new weaponSkillDamage(
        20,
        'Rending Arc',
        'RendingArc',
        'damage',
    ...
    savageStrike.damageDisplay = function () {
        return Math.floor(
            10 +
                weaponMastery.sword.level * 2 +
                player.functions.totalStrength() * 0.5 +
                player.functions.totalAgility() * 0.5
        );
    };
    savageStrike.damage = function () {
        return player.properties.isSword && weaponMastery.sword.level >= this.levelReq
            ? this.damageDisplay()
            : 0;
    };
    //LIFESTEAL
    ...
    sinisterSwing.damageDisplay = function () {
        return Math.floor(
            30 +
                weaponMastery.sword.level * 2 +
                player.functions.totalStrength() * 0.8 +
                player.functions.totalAgility() * 0.8
        );
    };
    ...
    rendingArc.damageDisplay = function () {
        return Math.floor(
            60 +
                weaponMastery.sword.level * 2 +
                player.functions.totalStrength() * 1.2 +
                player.functions.totalAgility() * 1.2
        );
    };
    ...
    swordFinesse.description = function () {
        return (
            ...
            this.damageDisplay() +
            '<br />' +
            '20% total agility added to your min and max damage.'
        );
    };
    ...
    var butchersInsight = new weaponSkillDamage(
        5,
        "Butcher\'s Insight",
        'ButchersInsight',
        'passive',
    ...
    var whirlwind = new weaponSkillDamage(
        10,
        'Whirlwind',
        'Whirlwind',
        'damage',
    ...
    hamstring.damageDisplay = function () {
        return Math.floor(
            20 +
                weaponMastery.axe.level * 4 +
                player.functions.totalStrength() * 0.6 +
                player.functions.totalEndurance() * 0.6
        );
    };
    hamstring.damage = function () {
        return player.properties.isAxe && weaponMastery.axe.level >= this.levelReq
            ? this.damageDisplay()
            : 0;
    };
    ...
    whirlwind.damageDisplay = function () {
        return Math.floor(
            40 +
                weaponMastery.axe.level * 4 +
                player.functions.totalStrength() * 0.9 +
                player.functions.totalEndurance() * 0.9
        );
    };
    ...
    flurry.damageDisplay = function () {
        return Math.floor(
            70 +
                weaponMastery.axe.level * 4 +
                player.functions.totalStrength() * 1.3 +
                player.functions.totalEndurance() * 1.3
        );
    };
    ...
    frenzy.damageDisplay = function () {
        return Math.floor(
            100 +
                weaponMastery.axe.level * 4 +
                player.functions.totalStrength() * 1.5 +
                player.functions.totalEndurance() * 1.5
        );
    };
    ...
    //MACE SKILL
    var hammerTime = new weaponSkillDamage(
        1,
        'Hammer Time',
        'HammerTime',
        'damage',
    ...
    var dominatingSlam = new weaponSkillDamage(
        5,
        'Dominating Slam',
        'DominatingSlam',
        'damage',
    ...
    var overbearingWallop = new weaponSkillDamage(
        15,
        'Overbearing Wallop',
        'OverBearingWallop',
        'damage',
    ...
    hammerTime.damageDisplay = function () {
        return Math.floor(
            15 +
                weaponMastery.mace.level * 3 +
                player.functions.totalEndurance() * 0.4 +
                player.functions.totalWisdom() * 0.4
        );
    };
    hammerTime.damage = function () {
        return player.properties.isMace && weaponMastery.mace.level >= this.levelReq
            ? this.damageDisplay()
            : 0;
    };
    ...
    dominatingSlam.damageDisplay = function () {
        return Math.floor(
            25 +
                weaponMastery.mace.level * 3 +
                player.functions.totalEndurance() * 0.7 +
                player.functions.totalWisdom() * 0.7
        );
    };
    ...
    gash.damageDisplay = function () {
        return Math.floor(
            50 +
                weaponMastery.mace.level * 3 +
                player.functions.totalEndurance() * 1.1 +
                player.functions.totalWisdom() * 1.1
        );
    };
    ...
    overbearingWallop.damageDisplay = function () {
        return Math.floor(
            80 +
                weaponMastery.mace.level * 3 +
                player.functions.totalEndurance() * 1.3 +
                player.functions.totalWisdom() * 1.3
        );
    };
    ...
    tremor.damageDisplay = function () {
        return Math.floor(
            125 +
                weaponMastery.mace.level * 3 +
                player.functions.totalEndurance() * 1.5 +
                player.functions.totalWisdom() * 1.5
        );
    };
    ...
    var hateCannon = new weaponSkillDamage(
        10,
        'Hate Cannon',
        'HateCannon',
        'damage',
    ...
    var beguilersOrb = new weaponSkillDamage(
        15,
        "Beguiler\'s Orb",
        'BeguilersOrb',
        'damage',
    ...
    var spellSimulacrum = new weaponSkillDamage(
        20,
        'Spell Simulacrum',
        'SpellSimulacrum',
        'passive',
    ...
    intone.damage = function () {
        return player.properties.isStaff && weaponMastery.staff.level >= this.levelReq
            ? this.damageDisplay()
            : 0;
    };
    ...
    spellSimulacrum.damage = function () {
        return player.properties.isStaff && weaponMastery.staff.level >= this.levelReq
            ? this.damageDisplay() / 100
            : 1; //else "1" because it's a multiplier.
    };
    ...
    intone.description = function () {
        return (
            ...
            this.chanceDisplay() +
            ')' +
            ' to empower one of your spells dealing bonus damage(' +
            this.damageDisplay() +
            ').<br/>' +
    ...
    //RANGED SKILL
    var pierceTheVeil = new weaponSkillDamage(
        1,
        'Pierce the Veil',
        'PierceTheVeil',
        'damage',
    ...
    var skyCracker = new weaponSkillDamage(
        5,
        'Sky Cracker',
        'SkyCracker',
        'damage',
    ...
    var archerFocus = new weaponSkillDamage(
        10,
        'Archer Focus',
        'ArcherFocus',
        'passive',
    ...
    var makeItRain = new weaponSkillDamage(
        15,
        'Make it Rain',
        'MakeItRain',
        'damage',
    ...
    var rangersRevenge = new weaponSkillDamage(
        20,
        "Ranger\'s Revenge",
        'RangersRevenge',
        'damage',
    ...
    pierceTheVeil.damageDisplay = function () {
        return Math.floor(
            30 +
                weaponMastery.ranged.level * 3 +
                player.functions.totalDexterity() * 0.7 +
                player.functions.totalStrength() * 0.7
        );
    };
    pierceTheVeil.damage = function () {
        return player.properties.isRanged && weaponMastery.ranged.level >= this.levelReq
            ? this.damageDisplay()
            : 0;
    };
    ...
    skyCracker.damageDisplay = function () {
        return Math.floor(
            50 +
                weaponMastery.ranged.level * 3 +
                player.functions.totalDexterity() * 0.9 +
                player.functions.totalStrength() * 0.9
        );
    };
    ...
    makeItRain.damageDisplay = function () {
        return Math.floor(
            70 +
                weaponMastery.ranged.level * 3 +
                player.functions.totalDexterity() * 1.1 +
                player.functions.totalStrength() * 1.1
        );
    };
    ...
    rangersRevenge.damageDisplay = function () {
        return Math.floor(
            90 +
                weaponMastery.ranged.level * 3 +
                player.functions.totalDexterity() * 1.3 +
                player.functions.totalStrength() * 1.3
        );
    };
