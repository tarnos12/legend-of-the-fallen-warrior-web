...
(function () {
    ...
    var smallPotion = new newPotion(
        1,
        150,
        'healing',
        'smallPotion',
        'Small Potion of Life',
        'health',
        0,
        'Health',
        10
    );
    var mediumPotion = new newPotion(
        5,
        500,
        'healing',
        'mediumPotion',
    ...
    var superPotion = new newPotion(
        15,
        2000,
        'healing',
        'superPotion',
        'Super Potion of Life',
        'health',
        0,
        'Health',
        70
    );
    var potionofStrength = new newPotion(
        5,
        20,
        'buff',
        'potionofStrength',
    ...
    var potionofEndurance = new newPotion(
        5,
        20,
        'buff',
        'potionofEndurance',
    ...
    var potionofAgility = new newPotion(
        5,
        20,
        'buff',
        'potionofAgility',
    ...
    var potionofDexterity = new newPotion(
        5,
        20,
        'buff',
        'potionofDexterity',
    ...
    var potionofWisdom = new newPotion(
        5,
        20,
        'buff',
        'potionofWisdom',
    ...
    var potionofIntelligence = new newPotion(
        5,
        20,
        'buff',
    ...
    var potionofLuck = new newPotion(
        5,
        20,
        'buff',
        'potionofLuck',
    ...
    var potionofAllStats = new newPotion(
        10,
        10,
        'buff',
        'potionofAllStats',
    ...
    var potionofItemDrop = new newPotion(
        15,
        50,
        'buff',
        'potionofItemDrop',
    ...
    var potionofGreed = new newPotion(
        15,
        100,
        'buff',
        'potionofGreed',
    ...
    var potionofExperience = new newPotion(
        15,
        100,
        'buff',
        'potionofExperience',
    ...
    mediumPotion.requirements = function () {
        return [
            { type: 'RusinsSinew', amount: 10 },
            { type: 'EssenceofWillow', amount: 5 },
        ];
    };
    ...
    potionofLuck.requirements = function () {
        return [
            { type: 'EssenceofWillow', amount: 5 },
            { type: 'SinnersDelight', amount: 1 },
        ];
    };
    potionofAllStats.requirements = function () {
        return [
            { type: 'RusinsSinew', amount: 20 },
            { type: 'EssenceofWillow', amount: 10 },
            { type: 'SinnersDelight', amount: 5 },
        ];
    };
    superPotion.requirements = function () {
        return [
            { type: 'RusinsSinew', amount: 15 },
            { type: 'EssenceofWillow', amount: 10 },
            { type: 'SinnersDelight', amount: 5 },
        ];
    };
    potionofItemDrop.requirements = function () {
        return [
            { type: 'EssenceofWillow', amount: 50 },
            { type: 'SinnersDelight', amount: 25 },
            { type: 'BarletBark', amount: 10 },
        ];
    };
...
export function createPotionInventory() {
    ...
    for (var item = 0; item < playerPotionList.length; item++) {
        if (playerPotionList.hasOwnProperty(item)) {
            ...
            html += '<div class="col-xs-6">';
            html +=
                '<button type="button" class="inventoryOther" onclick="addHotBarPotion(' +
                item +
                ')' +
                '">Hot Bar</button>';
            html += '</div>';
...
export function CreatePlayerHotBar() {
    ...
    for (var i = 0; i < hotBarItem.length; i++) {
        // 8 = hotbar slots;
        ...
        if (potionAmount > 0) {
            ...
            html +=
                '<img style="cursor:pointer;" src="images/' +
                potionName +
                '.png" onclick="usePotion(' +
                potionIndex +
                ');" alt="' +
...
function addHotBarPotion(potion) {
    //Effect = healing/stat bonus
